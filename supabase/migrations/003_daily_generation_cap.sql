...
ALTER TABLE entitlements ADD COLUMN daily_generations_used INTEGER DEFAULT 0;
ALTER TABLE entitlements ADD COLUMN last_generation_date DATE DEFAULT CURRENT_DATE;
